class SchedulePostsController < ApplicationController
  ...
  def schedule_post_params
    params.require(:schedule_post).permit(:trip_title, :latitude, :longitude, :inventory_list, :schedule_post_image, :address,trip_itineraries_attributes: [:id, :spot_name, :date_time, :body, :address, :_destroy])
  end
